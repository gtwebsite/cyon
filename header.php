...
<meta name="viewport" content="<?php if(of_get_option('responsive')==1){ echo 'target-densitydpi=device-dpi, width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0'; }else{ echo 'width=1024'; } ?>">
<?php if(of_get_option('responsive')==1){ echo '<meta name="apple-mobile-web-app-capable" content="yes" />'; } ?>
