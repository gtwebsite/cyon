...
jQuery(document).ready(function() {
	...
	var checkbackgroundstyle = function() {
		...
		if(bsvalue=='full'){
			jQuery('#section-background_style_full_option').show();
...
function optionsframework_options() {
	...
	*/
	...
	$options[] = array( 'name' 		=> __('Style','cyon'),
						...
						'std'		=> 'default',
						'type' 		=> 'select',
						'options' 	=> array('pattern'=>__('Pattern','cyon'), 'full'=>__('Full Screen Image','cyon'), 'full_slide'=>__('Full Screen Slide','cyon'), 'youtube'=>__('Youtube Video','cyon')));			

	$options[] = array( 'name' 		=> __('Full screen option','cyon'),
						'desc' 		=> '',
						'id' 		=> 'background_style_full_option',
						'std'		=> 'homepage',
						'type' 		=> 'radio',
						'options' 	=> array('homepage'=>__('Homepage only','cyon'), 'allpages'=>__('All pages','cyon')));			
